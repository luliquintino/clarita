...
import { patientsApi, alertsApi, authApi, invitationsApi, isAuthenticated, getUserRoleFromToken } from "@/lib/api";
  ...
  const loadData = async () => {
    ...
    try {
      ...
      if (alertsRes.status === "fulfilled") {
        ...
        setAlertCount(alertData.alerts?.length ?? (Array.isArray(alertData) ? (alertData as unknown[]).length : 0));
      } else {
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">
                  Gerencie e monitore seus pacientes
                </p>
              </div>
