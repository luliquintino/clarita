...
const phq9Zones = [
  ...
  { y1: 15, y2: 19, fill: "rgba(239, 68, 68, 0.08)", label: "Moderadamente Grave", color: "#ef4444" },
...
export default function AssessmentHistory({
  ...
  const gradientId =
    activeType === "PHQ-9" ? "phq9Gradient" : "gad7Gradient";
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-4">
        {(["PHQ-9", "GAD-7"] as AssessmentType[]).map((type) => {
          ...
          const iconBg =
            type === "PHQ-9"
              ? "bg-clarita-blue-100"
              : "bg-clarita-purple-100";
          const iconColor =
            type === "PHQ-9"
              ? "text-clarita-blue-500"
              : "text-clarita-purple-500";
            ...
            >
              ...
              <div className="text-left">
                ...
                <p className="text-xs text-gray-400">
                  {type === "PHQ-9" ? "Depressao" : "Ansiedade"} &middot;{" "}
                  {count} registros
                </p>
              </div>
            </button>
              ...
              <div className="flex items-center gap-2">
                {trend < 0 ? (
                  <>
                    <TrendingDown
                      size={20}
                      className="text-clarita-green-500"
                    />
      ...
      <div className="card">
        <h3 className="section-title">
          Historico de Pontuacao {activeType}
        </h3>
