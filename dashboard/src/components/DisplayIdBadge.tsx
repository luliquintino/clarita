...
export default function DisplayIdBadge({ displayId, label, size = 'md' }: DisplayIdBadgeProps) {
  ...
  return (
    <div className="inline-flex items-center gap-2">
      ...
      >
        <span className="font-mono text-xs text-gray-500 tracking-wide">{displayId}</span>
        <span
